...
while (transactions > 0)
{
    ...
    Console.WriteLine(TillAmountSummary(cashTill));
    Console.WriteLine($"Expected till value: {registerCheckTillTotal}");
    Console.WriteLine($"Transaction number: {counter}");
    Console.WriteLine();
}
...
{
    int newTwenties = cashTill[3] + twenties;
    int newTens = cashTill[2] + tens;
    int newFives = cashTill[1] + fives;
    int newOnes = cashTill[0] + ones;
    ...
    while ((changeNeeded > 19) && (newTwenties > 0))
    {
        newTwenties--;
        changeNeeded -= 20;
    ...
    while ((changeNeeded > 9) && (newTens > 0))
    {
        newTens--;
        changeNeeded -= 10;
    ...
    while ((changeNeeded > 4) && (newFives > 0))
    {
        newFives--;
        changeNeeded -= 5;
    ...
    while ((changeNeeded > 0) && (newOnes > 0))
    {
        newOnes--;
        changeNeeded -= 1;
